...
public class Tropical8sWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Tropical8sWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Tropical8sIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Tropical8sIW/InitOutcome.xml").getDocumentElement();
